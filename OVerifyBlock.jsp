      ...
      <div class="mainbar">
        <div class="article style8">
          ...
          <table width="598" border="1" align="center">
            ...
            <tr>
              <td>Select The Cloud</td>
              <td><select name="block"  >
			  <option>--Select--</option>
			  <option value=Block1>Cloud1</option>
			   <option value=Block2>Cloud2</option>
			    <option value=Block3>Cloud3</option>
				 <option value=Block4>Cloud4</option>
			  </select></td>
            </tr>
