...
.style7 {font-size: 14px; color: #FF0000; font-weight: bold; }
-->
</style>
</head>
<body>
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style3"> ACCESS AND DOWNLOAD FILE </span><span class="style3">!!!</span></h2>
          <p class="infopost">&nbsp; <a href="#" class="com"></a></p>
          <div class="clr"></div>
          
		  
		<form action="EndDownloadFile1.jsp" method="post" name="form1" id="form1">
<table width="478" border="0" align="center">
	...
	<tr>
		<td height="34" bgcolor="#FFFF00"><span class="style7">Cloud 1:-</span></td>
		<td><input name="t12" type="text" size="40" /></td>
	</tr>
	<tr>
		<td height="34" bgcolor="#FFFF00"><span class="style7">Cloud 2:-</span></td>
		<td><input name="t122" type="text" size="40" /></td>
	</tr>
	<tr>
		<td height="34" bgcolor="#FFFF00"><span class="style7">Cloud 3:-</span></td>
		<td><input name="t123" type="text" size="40" /></td>
	</tr>
	<tr>
		<td height="34" bgcolor="#FFFF00"><span class="style7">Cloud 4:-</span></td>
