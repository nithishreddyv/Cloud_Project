...
<tr><td align="center" bgcolor="#FFFF00"><span class="style6">Select Cloud</span></td>
<td><select name="block" ><option>--Select--</option>
<option value=block-1>Cloud-1</option>
<option value=block-2>Cloud-2</option>
<option value=block-3>Cloud-3</option>
<option value=block-4>Cloud-4</option>
</select> </td></tr>
